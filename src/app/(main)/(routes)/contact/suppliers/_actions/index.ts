...
export const getSpecificSupplier = async (
  id: number,
  token: string,
  business_id: number
) => {
...
export const deleteRider = async (id: number, token: string) => {
  try {
    const { data } = await axios.post(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/supplier/delete/${id}`,
      null,
      {
        headers: {
          "Content-Type": "application/json",
...
export const createSupplier = async (userData: AddUserInput, token: string) => {
  ...
  try {
    ...
    const response = await axios.post(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/supplier/register`,
      payload,
      {
        headers: {
          "Content-Type": "application/json",
...
export const editSupplier = async (
  ...
  try {
    const { data } = await axios.post(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/supplier/edit/${id}`,
      payload,
      {
        headers: {
          "Content-Type": "application/json",
